...
export const modeHeaders: Record<string, string> = {
  mode: "Mode",
  icon: "Icon",
  transferCase: "Transfer Case Setting",
  tcOptions: "Available Transfer Case Settings",
  tractionControl: "Traction Control Setting",
  frontDiffLocker: "Front Locking Differential",
  fdLockerOptions: "Front Locking Options",
  rearDiffLocker: "Rear Locking Differential",
  rdLockerOptions: "Rear Locking Options",
  throttle: "Throttle",
  steering: "Steering",
  stayBarDisconnect: "Sta-Bar Disconnect",
  sbDisconnectOptions: "Sta-Bar Options",
}
...
export const GoatModeData: modeData[] = [
  {
    ...
    tcOptions: [
      transferCaseSelections["twoHigh"],
      transferCaseSelections["fourHigh"],
      transferCaseSelections["fourAuto"],
      transferCaseSelections["fourLow"],
    ],
