    ...
    <>
      ...
      <main className="page-content">
        ...
        <div className="home--nav-cards">
          <NavCard title="Recovery" link="recovery/gear" image={stuckBronco}>Off-road recoveries occur when the driver and vehicle are unable to continue, generally due to a loss of traction.</NavCard>
          <NavCard title="Offroading" link="offroading" image={offRoading}>Off-Roading, as we talk about it, is done mostly with **Broncos** and **Bronco Sports**.</NavCard>
        </div>
