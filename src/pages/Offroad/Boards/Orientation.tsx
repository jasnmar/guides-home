    ...
    <>
      ...
      <div className="data-container">
        ...
        <div className="offroad-right-one-third">
          <Aside asideText="Trail Turn Assist helps manage tight turns on the trail by reducing the turning radius by as much as 40%. It does this by applying the brake to the inside rear wheel as the vehicle turns in low-speed off-road environments" />
        </div>
      </div>
    </>
  )
