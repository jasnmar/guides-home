...
function GroundSchool() {
  ...
  const info1 = [
    ...
    {id:"3", data:"Maximum Breakover Angle 29.0 degrees"},
    {id:"4", data:"Maximum Ground Clearance 11.6 inches"}
  ]
  const info2 = [
    {id:"100", data:"Front Locking Differential"},
    {id:"101", data:"Rear Locking Differential"},
    {id:"102", data:"7-Speed Manual Transmission (6+1 with Crawler Gear) OR 10-Speed Automatic Transmission with Trail Control"},
    {id:"103", data:"Two-Speed 4x4 Transfer Case with Low-Range (4L)"}
  ]  
  return (
    <>
